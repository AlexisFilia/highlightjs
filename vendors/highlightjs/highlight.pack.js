...
},e.C_LINE_COMMENT_MODE,e.C_BLOCK_COMMENT_MODE]},b]}}})());hljs.registerLanguage("matlab",(()=>{"use strict";return e=>{var a={relevance:0,
...
className:"meta",begin:"@[A-Za-z]+"},{begin:"=>"}]}}})());hljs.registerLanguage("purebasic",(()=>{"use strict";return e=>({
...
end:'"',illegal:"\\n"},{className:"symbol",begin:"#[a-zA-Z_]\\w*\\$?"}]})})());hljs.registerLanguage("diff",(()=>{"use strict";return e=>({name:"Diff",
...
name:"Elixir",keywords:i,contains:t}}})());hljs.registerLanguage("vbscript",(()=>{"use strict";function e(e){
...
relevance:0}),e.C_NUMBER_MODE]}}})());hljs.registerLanguage("twig",(()=>{"use strict";return e=>{
...
begin:/\{\{/,end:/\}\}/,contains:["self",t,n]}]}}})());hljs.registerLanguage("applescript",(()=>{"use strict";return e=>{
...
}].concat(n),illegal:"//|->|=>|\\[\\["}}})());hljs.registerLanguage("http",(()=>{"use strict";return e=>{
...
className:"number",begin:"(&[oO][0-7]{1,6})"}]})})());hljs.registerLanguage("monkey",(()=>{"use strict";return e=>{const n={
...
contains:[e.UNDERSCORE_TITLE_MODE]},e.QUOTE_STRING_MODE,n]}}})());hljs.registerLanguage("ruby",(()=>{"use strict";function e(...e){
return e.map((e=>{return(n=e)?"string"==typeof n?n:n.source:null;var n
})).join("")}return n=>{
var a,i="([a-zA-Z_]\\w*[!?=]?|[-+~]@|<<|>>|=~|===?|<=>|[<>]=?|\\*\\*|[-/+%^&*~`|]|\\[\\]=?)",s={
...
begin:"\\."+e.UNDERSCORE_IDENT_RE,relevance:0}]}}})());hljs.registerLanguage("actionscript",(()=>{"use strict";return e=>({
...
begin:/\(/,end:/\)/,keywords:n,illegal:/["']/}]}]}}})());hljs.registerLanguage("livescript",(()=>{"use strict"
...
returnEnd:!0,relevance:0}])}}})());hljs.registerLanguage("css",(()=>{"use strict";return e=>{
...
end:"$",illegal:"\n"},o]}}})());hljs.registerLanguage("latex",(()=>{"use strict";return e=>{const n=[{
...
contains:a,keywords:e,illegal:"\\S"}}})());hljs.registerLanguage("fortran",(()=>{"use strict";function e(...e){
return e.map((e=>{return(n=e)?"string"==typeof n?n:n.source:null;var n
...
begin:t,end:a,contains:[n],relevance:5}])}}})());hljs.registerLanguage("vbnet",(()=>{"use strict";return e=>({
...
"meta-keyword":"if else elseif end region externalsource"}}]})})());hljs.registerLanguage("java",(()=>{"use strict"
;var e="\\.([0-9](_*[0-9])*)",n="[0-9a-fA-F](_*[0-9a-fA-F])*",a={
className:"number",variants:[{
begin:`(\\b([0-9](_*[0-9])*)((${e})|\\.)?|(${e}))[eE][+-]?([0-9](_*[0-9])*)[fFdD]?\\b`
},{begin:`\\b([0-9](_*[0-9])*)((${e})[fFdD]?\\b|\\.([fFdD]\\b)?)`},{
...
subLanguage:"bash"}}]})})());hljs.registerLanguage("livecodeserver",(()=>{"use strict";return e=>{const r={
...
illegal:";$|^\\[|^=|&|\\{"}}})());hljs.registerLanguage("javascript",(()=>{"use strict"
;const e="[A-Za-z$_][0-9A-Za-z$_]*",n=["as","in","of","if","for","while","finally","var","new","function","do","return","void","else","break","catch","instanceof","with","throw","case","default","try","switch","continue","typeof","delete","let","yield","const","class","debugger","async","await","static","import","from","export","extends"],a=["true","false","null","undefined","NaN","Infinity"],s=[].concat(["setInterval","setTimeout","clearInterval","clearTimeout","require","exports","eval","isFinite","isNaN","parseFloat","parseInt","decodeURI","decodeURIComponent","encodeURI","encodeURIComponent","escape","unescape"],["arguments","this","super","console","window","document","localStorage","module","global"],["Intl","DataView","Number","Math","Date","String","RegExp","Object","Function","Boolean","Error","Symbol","Set","Map","WeakSet","WeakMap","Proxy","Reflect","JSON","Promise","Float64Array","Int16Array","Int32Array","Int8Array","Uint16Array","Uint32Array","Float32Array","Array","Uint8Array","Uint8ClampedArray","ArrayBuffer"],["EvalError","InternalError","RangeError","ReferenceError","SyntaxError","TypeError","URIError"])
